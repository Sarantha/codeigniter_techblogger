...
// post and post controller routes
$routes->get('/posts/(:any)/delete','PostController::delete/$1');
$routes->get('/posts/(:any)','PostController::show/$1');
$routes->get('/posts/(:any)/edit','PostController::edit/$1');
$routes->get('/post', 'PostController::index');
$routes->post('/post/create', 'PostController::create');
$routes->get('/posts/search', 'PostController::search');
$routes->post('/sendemail', 'PostController::sendEmail');

//$routes->match(['get','post'],'posts/create','PostController::create');
/*
